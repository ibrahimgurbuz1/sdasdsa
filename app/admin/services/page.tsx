...
export default function Services() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showNewService && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" onClick={() => { setShowNewService(false); setEditingService(null); resetForm(); }}>
